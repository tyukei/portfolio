...
export declare const comboboxContextId: import('@builder.io/qwik').ContextId<ComboboxContext>;
...
export declare const comboboxItemContextId: import('@builder.io/qwik').ContextId<ComboboxItemContext>;
