...
const hiddenSelectOption = require("./hidden-select-option.qwik.cjs");
const visuallyHidden = require("../../utils/visually-hidden.qwik.cjs");
const HHiddenNativeSelect = qwik.component$((props) => {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("select", {
            ...
            children: [
              ...
              Array.from(context.itemsMapSig.value.entries()).map(([index, item]) => /* @__PURE__ */ jsxRuntime.jsx(hiddenSelectOption.HiddenSelectOption, {
                value: item.value,
...
exports.HHiddenNativeSelect = HHiddenNativeSelect;
