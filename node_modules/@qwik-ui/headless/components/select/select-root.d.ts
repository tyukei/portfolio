import { PropsOf, Signal, QRL } from '@builder.io/qwik';
export type TItemsMap = Map<number, {
    value: string;
    displayValue: string;
    disabled: boolean;
}>;
...
export type SelectProps<M extends boolean = boolean> = Omit<PropsOf<'div'>, 'onChange$'> & {
    ...
    multiple?: M;
    invalid?: boolean;
} & TMultiValue & TStringOrArray;
export declare const HSelectImpl: import('@builder.io/qwik').Component<(Omit<{
    align?: string | undefined;
} & import('@builder.io/qwik').HTMLElementAttrs & import('@builder.io/qwik').QwikAttributes<HTMLDivElement>, "onChange$"> & {
    /** A signal that controls the current selected value (controlled). */
    'bind:value'?: Signal<string | string[]> | undefined;
    /** A signal that controls the current open state (controlled). */
    'bind:open'?: Signal<boolean>;
    'bind:displayValue'?: Signal<string | string[]> | undefined;
    /**
     * QRL handler that runs when a select value changes.
     * @param value The new value as a string.
     */
    onChange$?: QRL<(value: string | string[]) => void> | undefined;
    /**
     * QRL handler that runs when the listbox opens or closes.
     * @param open The new state of the listbox.
     *
