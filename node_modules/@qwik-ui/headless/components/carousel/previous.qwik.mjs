...
import { component$, useContext, useSignal, useComputed$, $, Slot } from "@builder.io/qwik";
import { carouselContextId } from "./context.qwik.mjs";
import { useCarousel } from "./use-carousel.qwik.mjs";
const CarouselPrevious = component$((props) => {
  ...
  const handleFocusNext$ = $(() => {
    ...
    if (isKeyboardFocusSig.value && context.currentIndexSig.value === isFirstScrollableIndexSig.value) {
